...
<body style="background-color:#f0f0f0">
    ...
    <div class="container" style="margin-top: 100px; background:#fff; padding:10px">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <form action="users.php" method="GET">
                        ...
                        <input type="search" name="dataInput" class="form-control" placeholder=" Rechercher"
                            style="width: 100%;">
    ...
    <div class="container" style="background-color: white; margin-top:20px; padding:10px">
        <div class="detail">
            <p>
