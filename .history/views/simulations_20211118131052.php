        ...
        <div class="col-md-12">
            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div>
                                    ...
                                    <button class="btn btn-primary stop" id="stop_ddos" style="display: none;">Stopper l'attaque</button>
                ...
                <div class='col-md-6 divC'>
                    <div class="col-md-12 ml-5" style="padding-left: 0; padding-right: 0; margin-top: 10px;">
                        <div class="row">
                            <h5>Résultat</h5>
                            <div id="res"></div>
                            <p></p>
