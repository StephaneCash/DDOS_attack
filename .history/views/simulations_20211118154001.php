        ...
        <div class="col-md-12">
            <div class="row">
                <div class='col-md-6 divL'>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div>
                                    ...
                                    <button class="btn btn-danger force" id="force">Forcer l'attaque</button>
                    ...
                    <div class="col-md-12" id='xss' style="padding-left: 0; padding-right: 0; margin-top: 40px; display:none">
                        <div class="row">
                            <div class="col-md-12">
