...
<body style="background-color: #f0f0f0;">
        ...
        <div class="col-md-12">
            <div class="row">
                <div class='col-md-6 divL'>
                    <div class="col-md-12" style="padding:10px; margin-top: 10px;background-color:white; box-shadow:2px 2px 10px 2px silver">
                        <div class="row">
                            <div class="col-md-12">
                    ...
                    <div class="col-md-12 ddos" style="padding:10px; background-color:white; margin-top: 40px; display:none; box-shadow:2px 2px 10px 2px silver">
                        <div class="row">
                            <div class="col-md-12">
                                <p>
                                    Attak ddos
                    ...
                    <div class="col-md-12" id='xss' style="padding:10px;background-color:white; margin-top: 40px; display:none;box-shadow:2px 2px 10px 2px silver">
                        <div class="row">
                            <div class="col-md-12">
    ...
    <script src="../jsFiles/simulati.js"></script>
