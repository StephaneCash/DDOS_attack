...
<body style="background-color:#f0f0f0">
    ...
    <div class="container">
        <div class="col-md-12" style="margin-top:100px; box-shadow:2px 2px 10px 2px silver; background-color: white; ">
            <div class="row">
                <h4 style="border:1px solid silver; padding:10px; margin-bottom:10px; margin:20px">Ajouter un nouvel user</h4>
                <div class="col-md-12" style="border:1px solid silver; padding:20px">
                    ...
                    <form action="../back/addUser.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="email" placeholder="Une adresse email svp" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" name="password" placeholder="Entrer un password" required>
                        </div>
                        <div class="form-group">
